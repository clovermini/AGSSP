...
work_dir = './work_dirs/own_pretrain/metal_ft_cos_frozen/train_mini_500/yolov8_s_syncbn_fast_1xb32-500e_pipe_4cate/'
...
default_hooks = dict(
    checkpoint=dict(interval=10, max_keep_ckpts=2, save_best='coco/bbox_mAP_50'),

...
def auto_arrange_images(image_list: list, image_column: int = 3) -> np.ndarray:
    ...
    if img_count <= image_column:
        ...
        #print('fill_img_list ', len(fill_img_list))
        #print('image_row ', image_row, ' image_list.extend ', len(image_list), ' image_column ', image_column)
        merge_imgs_col = []

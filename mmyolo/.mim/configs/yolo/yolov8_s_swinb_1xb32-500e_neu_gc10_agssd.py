...
work_dir = './work_dirs/own_pretrain/metal_ft_l2_frozen_simmim/yolov8_s_swinb_1xb32-500e_gc10/'
...
load_from = '/home/data/liuchuni/projects/defect_detection/weights/own_pretrain/metal_ft_swinb_l2_frozen_simmim_epoch_10.pth'
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/train.json',  # train_mini_500

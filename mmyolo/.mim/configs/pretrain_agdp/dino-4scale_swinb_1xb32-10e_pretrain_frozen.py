...
work_dir = './work_dirs/metal_simmim_distill_multi_frozen/dino-4scale_swinb_1xb32-10e_pretrain_frozen'  # head_finetune with coco
...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        mean=[101.57, 101.57, 101.57],  # noqa
        std=[61.2, 61.2, 61.2],
        bgr_to_rgb=True,
        pad_size_divisor=1),
    backbone=dict(

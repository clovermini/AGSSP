...
work_dir = './work_dirs/resnet50_1xb256_metal'

# schedule settings fp16 amp setting
optim_wrapper = dict(type='AmpOptimWrapper', loss_scale='dynamic')

model = dict(
    backbone=dict(init_cfg=dict(type='Pretrained', checkpoint='./weights/resnet50-0676ba61.pth')),
    head=dict(num_classes=num_classes))

default_hooks = dict(
    checkpoint=dict(interval=10, max_keep_ckpts=50, save_best='accuracy/top1'),

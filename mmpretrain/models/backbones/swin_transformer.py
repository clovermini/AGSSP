    ...
    def __init__(self,
        ...
        for i in out_indices:
            if norm_cfg is not None:
                ...
                print('norm_layer ', i, ' ', self.num_features[i], ' out_after_downsample ', self.out_after_downsample)
            else:
    ...
    def forward(self, x):
        ...
        for i, stage in enumerate(self.stages):
            ...
            if i in self.out_indices:
                ...
                #print('norm_layer 2 ', i, ' ', norm_layer, ' x ', x.shape, ' out_after_downsample ', self.out_after_downsample)
                out = norm_layer(x)
    ...
    def _freeze_stages(self):
        ...
        for i in range(0, self.frozen_stages + 1):
            ...
            for param in m.parameters():
                param.requires_grad = False
        print('frozen_stages ', self.frozen_stages, ' out_indices ', self.out_indices)
